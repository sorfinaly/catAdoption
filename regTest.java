...
public class regTest extends Application {
	...
	private String months[] = { "Jan", "feb", "Mar", "Apr",
     ...
     private String years[] = { "1962", "1963", "1964", "1965",
        ...
        submitButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                if(txtEmail.getText().isEmpty()) {
                    showAlert(Alert.AlertType.ERROR, grid.getScene().getWindow(), "Form Error!", "Please enter your e-mail");
                    return;
                }
                ...
                if(!agreement.isSelected()) {
                    showAlert(Alert.AlertType.ERROR, grid.getScene().getWindow(), "Form Error!", "Please tick the agreement");
                    return;
                }

                showAlert(Alert.AlertType.CONFIRMATION, grid.getScene().getWindow(), "Registration Successful!\n", "Do you want to donate to the shelter? " + txtName.getText());
            }
        });
